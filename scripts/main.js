var employeeListHolder = document.querySelector(".employe-list");
...
addInterviewModal.computedStyleMap.display="none";
...
function addEmployee(){
   ...
   <li>
        ...
        <img class ="user-img" src="images/2.jpg" alt="">
        <span>
...
function addInterview(){
    ...
    var positionInterview = document.querySelector("#int-posotion").value;
    var newInterview = `
    <li>
    <div class ="list-item">
